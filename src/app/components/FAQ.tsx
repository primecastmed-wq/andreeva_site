  ...
  const faqs = [
    {
      ...
      answer:
        "Стоимость индивидуальная, от 130 000 ₽. Точную цену называю после бесплатной консультации, чтобы подобрать оптимальный формат под ваш бизнес и не переплачивать за лишний объем работ.",
    },
    {
